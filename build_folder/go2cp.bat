...
REM BOOT FILES
copy c:\my_code\na\Binaries.prebuilt\NOXARCH.SYSTEM.PROTECTED.BIN c:\ac1.3.5\NOXARCH.SYSTEM.BIN
...
c:\my_code\na\disk_image_masters\copy NA_boot.protected.nib c:\ac1.3.5\my.program.nib
c:\my_code\na\disk_image_masters\copy NA_player.protected.nib c:\ac1.3.5\my.main_player.nib
c:\my_code\na\disk_image_masters\copy NA_player.protected.nib c:\ac1.3.5\na.town_disk.nib
c:\my_code\na\disk_image_masters\copy NA_player.protected.nib c:\ac1.3.5\na.undermap_disk.nib
c:\my_code\na\disk_image_masters\copy NA_player.protected.nib c:\ac1.3.5\na.castle_disk.nib
...
REM MAIN FILES
java -jar ac.jar -p my.program.nib NOX_FONT.SET bin 0xC00 < c:\my_code\na\Binaries.prebuilt\nox_font.set.bin
