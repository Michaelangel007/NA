...
REM ==Format: map.compression.bat <data file name> <target file size in $sectors>, <use compression flags; $01 = ON | $00 = OFF, off means all zones are compressed)
