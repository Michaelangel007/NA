...
.NO_WEAPON.INIT
	...
	;**OPT** Memory. It is possible the init could be skipped for the above values. i.e. if the combat code ignores the nibble with the garbage data because there is no 
	;weapon in that hand then it shouldn't hurt anything. But for testing doing the init seems helpful.
	;the inits below are always needed because they affect values which appear on screen in the stats sub_module of the inventory module
...
.LEFT_HAND.NO_WEAPON
	...
	;
	;update: already done in .NO_WEAPON.INIT
