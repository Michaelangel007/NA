...
ANIMATION.MT.FINAL_TILE_TYPE	.EQ SCREEN_HOLE.20F8_20FF+$4	;$1bytes. HOLDS THE FINAL TILE_TYPE FOR MT MOBS, NET OF ANY ADJUSTMENTS FOR THE MT TILE # (0-3)
					   	        ;===IN USE==			 +$5
					   	        ;===IN USE==			 +$6
...
RETURN.RMAP				.EQ SCREEN_HOLE.23F8_23FF+$3	;$1byte. stores return value for CONVERT.RMAP_XY.RMAP
						;==IN USE==				 ;$4
