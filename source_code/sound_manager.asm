...
;**OPT** Memory. This entire file should be reviewed. Make sure PLAY.SOUND and PLAY.SOUND.REPEAT are used enough to pay for their existance. 
...
.SAVE		;SAVE REGISTERES
	PHA		;**OPT** Speed. Memory. Probably isn't needed. If removed, remove the corresponding PLA from the restore registers section. 
	TXA
	PHA
	TYA
	PHA
