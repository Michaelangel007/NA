...
copy BS_ROUTINES.BANK2.bin c:\ac1.3.5
del BS_ROUTINES.BANK2.bin

copy BS_ROUTINES.BANK1.bin c:\ac1.3.5
del BS_ROUTINES.BANK1.bin
...
java -jar ac.jar -p my.main_player.dsk BS_ROUTINES.BANK2 B 0xD000 < BS_ROUTINES.BANK2.bin
...
java -jar ac.jar -p my.main_player.dsk DATA.MAP.UNDERMAP_LV1 B 0x6000 < COMPRESSED.DATA.MAP.UNDERMAP_LV1.BIN
java -jar ac.jar -p my.main_player.dsk BS_ROUTINES.BANK1 B 0xD000 < BS_ROUTINES.BANK1.bin



REM java -jar ac.jar -p my.main_player.dsk test B 0x6000 < DATA.SHAPES.SURFACE.BIN
