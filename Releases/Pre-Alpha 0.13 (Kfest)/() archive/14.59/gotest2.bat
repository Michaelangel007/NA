...
java -jar ac.jar -p APPLEHDD.PO TEST.SWORD bin 0x2000 < TEST.SWORD.bin 
java -jar ac.jar -p APPLEHDD.PO TEST.FENCE3 bin 0x2000 < TEST.FENCE3.bin 
java -jar ac.jar -p APPLEHDD.PO TEST.48 bin 0x2000 < TEST.48.bin 
