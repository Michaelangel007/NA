...
.PAGE1.CURRENTLY.FOREGROUND
	LDA #$00			;SPECIFY COPY FROM ADDRESS
	STA COPYFROM
	LDA #$20
	STA COPYFROM+$1
	
	LDA #$00			;SPECIFY COPY TO ADDRESS
	STA COPYTO			;THIS SHOULD MATCH THE .ORG STATEMENT BELOW FOR THE TEST PROGRAM
	LDA #$40
	STA COPYTO+$1
	LDA #$60
