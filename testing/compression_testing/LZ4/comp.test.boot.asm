...
;set filename to read from	
	lda #COMP.PROG		;load LO address
	sta namlo
	lda /COMP.PROG		;load HO address
	sta namhi
...
COMP.PROG  .AZ #$09,/COMP.PROG/	;ascii array, using LO values. Filename is limited to !15 characters. Hex value after .AZ is the char quantity. 
