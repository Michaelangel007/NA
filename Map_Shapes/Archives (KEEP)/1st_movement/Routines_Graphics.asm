...
.P2	
	LDA #$60
	STA SCLEAR.PAGE.STOP.ADDRESS	;SETUP PAGE2 CLEAR
...
.START
	...
	LDA #$00
	STA LINE.BASE.ADDR				;ALL 3 SCENARIOS HAVE $00 IN THE LO BYTE
...
GET.LINE.ADDRESS		;============GET BASE MEMORY ADDRESS FOR GIVEN LINE (X)=========
