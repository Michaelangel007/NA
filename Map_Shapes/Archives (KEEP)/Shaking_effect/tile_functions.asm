...
GMAP.TALLY					.EQ $9106					;2byt	(16-BIT)
GMAP.LOOKUP					.EQ	$9108					;2byt   (16-BIT)

GMAP.INDEX.LO				.EQ $910A					;2byt	(16-BIT)
GMAP.INDEX.HO				.EQ $910B					;paired with preceding
...
SCREEN.TILE.DATA 			.EQ	$9000					;replace with .BS $BA byts	;HOLDS TILE_TYPE DATAT FOR EACH TILE ON VIEW SCREEN
SCREEN.TILE.HOPPER			.EQ	$90BC					;replace with .BS $0A. 		;HOLDS ONE COLUMN OF TILES TILE_TYPE DATA ON DECK FOR SCREEN DRAWING (USED AFTER SCREEN SCROLLING)
SCREEN.DARK.HOPPER			.EQ $90C7					;replace with .BS $0A. 		;(MIRROR OF SCREEN.TILE.HOPPER, BUT FOR DARKNESS FLAGS)
GMAP.EXPAND.TALLY			.BS	$1		
GMAP.INDEX.OVERFLOW			.BS	$1						;1byt
GMAP.INDEX.QUANTITY			.BS	$1						;1byt
TEMP						.BS $1						;1byt
SAVED.ACC					.EQ $90BB					;1byt **CHANGE TO .BS**
