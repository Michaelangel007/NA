...
.LOOP	
	...
	STA SCREEN.TILE.ROW,X		;*CLARITY* RENAME THIS VARIABLE TO SCREEN.TILE.DATA SO IT DOESN'T IMPLY ROW OR COLUMN

	INX							;INCREMENT COUNTER FOR WRITING TO SCREEN.TILE.ROW ARRAY
...
SCREEN.TILE.ROW 			.EQ	$8000			 		;remove absolute reference. $11byts
