...
J			.EQ $fb                   ; Uses two bytes. Has to be on zero-page
j_plus_h	.EQ $fd                   ; Uses two bytes. Has to be on zero-page
arr_length	.EQ j_plus_h              ; Can safely use the same location as
                                      ; j_plus_h, but doesn't have to be on ZP

	.NO $7000
			;  00.01.02.03.04.05.06.07.08.09
TEST.TABLE .HS 08.00.04.03.03.01.02.03.01.02
;			   08.00.01.01.07.01.0A.01.0F.01									  