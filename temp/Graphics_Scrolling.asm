...
;**OPT** SPEED. MAYBE INSTEAD OF INC TO SCREEN.DRAW.CURRENT_BYTE WE COULD JUST DO INY USE SCREEN.DRAW.CURRENT_BYTE TO INIT Y AT THE START OF THIS ROUTINE (I THINK WE ALREADY DO). WOULD NEED TO REVIW HOW THE EXIT FROM THIS ROUTINE WORKS, ADJUST IT TO Y IF ITS BASED ON SCREEN.DRAW.CURRENT_BYTE. ALSO CONSIDER THE IMPLICATIONS IN THE ROUTINE THAT CALLS THIS ONE. MAY NEED TO SAVE Y TO SCREEN.DRAW.CURRENT_BYTE AT END OF THIS ROUTINE, OR CONTINUE THE CONVERSION HIGHER UP. 	
...
;**OPT** SPEED. MAYBE INSTEAD OF INC TO SCREEN.DRAW.CURRENT_BYTE WE COULD JUST DO INY USE SCREEN.DRAW.CURRENT_BYTE TO INIT Y AT THE START OF THIS ROUTINE (I THINK WE ALREADY DO). WOULD NEED TO REVIW HOW THE EXIT FROM THIS ROUTINE WORKS, ADJUST IT TO Y IF ITS BASED ON SCREEN.DRAW.CURRENT_BYTE. ALSO CONSIDER THE IMPLICATIONS IN THE ROUTINE THAT CALLS THIS ONE. MAY NEED TO SAVE Y TO SCREEN.DRAW.CURRENT_BYTE AT END OF THIS ROUTINE, OR CONTINUE THE CONVERSION HIGHER UP. 	
	...
	LDY SCREEN.DRAW.CURRENT_BYTE			;LOAD UPDATED SCREEN.DRAW.CURRENT_BYTE INDEX INTO Y-REG
...
.ALL.ROW.MOVES
	...
	INC SCREEN.DRAW.CURRENT_BYTE			;IF YES, NEXT TILE
...
.MAINLOOP
	...
	LDA #SCREEN.DRAW.STOP_BYTE			;AT RIGHT SIDE SCREEN YET?
	CMP SCREEN.DRAW.CURRENT_BYTE
	BCS .MAINLOOP					;IF NO, SWITCH OVER TO NEXT ROW (BCS: is ACC >= CMP value)
